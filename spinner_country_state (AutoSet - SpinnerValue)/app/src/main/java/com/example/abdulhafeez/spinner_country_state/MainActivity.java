...
public class MainActivity extends AppCompatActivity {
    ...
    private void printPlayer2(ArrayList<TheState> state,String id) {
        ...
        if(changeValueState == 1){
            // Toast.makeText(getApplicationContext(), StateList+"", Toast.LENGTH_LONG).show();
            changeValueState = StateList.indexOf("Al Buhayrah");
            State.setSelection(changeValueState);
        }
    }

    public void set_default_country_state_function(View view){
    ...
    public void showInformationFunction(View view) {
        Toast.makeText(getApplicationContext(),"Country : "+selected_country_string+"\nState : "+selected_state_string,Toast.LENGTH_LONG).show();
    }
}